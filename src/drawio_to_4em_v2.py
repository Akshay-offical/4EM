...
RELATION_TYPE_ENUM = {
    ...
    "Actors and Resources Model": {
        "", "belongs to", "interacts with", "maintains", "plays", "works in",
    },
    "Concepts Model": {
...
def main():
    ...
    parser.add_argument("output", help="Path to output .adl file")
    parser.add_argument(
        "--model-type", "-t", default=None, choices=ALL_MODEL_TYPES,
        help="Override auto-detected 4EM model type."
    )
    parser.add_argument(
        "--model-name", "-n", default=None,
